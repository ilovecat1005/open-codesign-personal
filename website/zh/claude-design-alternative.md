...
Claude Design 是 Anthropic 提供的托管 Web 应用，跑在 Claude Opus 上。Open CoDesign 是 Apache-2.0 桌面应用，跑在你自己电脑上，用任意你已经在用的模型 provider。
...
- **协议？** Apache-2.0。可 Fork、可商用、可分发，保留 NOTICE 即可。
